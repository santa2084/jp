// new1
$('.new1').children('p').text('①【最新2022】おすすめwebスクール');
$('.images1').attr('src','../webschool/images/school.png');
$('.more1').attr('href','../webschool/index.html');
// new1
// new2
$('.new2').children('p').text('②【最新2022】ブログって何？');
$('.images2').attr('src','../images/blog.jpeg');
$('.more2').attr('href','../blog/index.html');
// new2
// new3
$('.new3').children('p').text('③【秘密】ハッカー独学【最高峰】');
$('.images3').attr('src','../hackerone/images/hacker.jpeg');
$('.more3').attr('href','../hackerone/index.html');
// new3
...
// nav
$('#nav-1').html('<a class="nav-link active" aria-current="page" href="../index.html" id="nav-1">home</a>');
