...
$('.archive').children('ul').prepend('<li style="padding:5px;"><a href="#">2022 12</a></li>');
...
// portfolioのショートカット
$('.portfolio').children('ul').prepend('<li style="padding:5px;"><a href="#">サイト運営の仕方　作成中</a></li>');
...
$('#nav-2').html('<a class="nav-link active" aria-current="page" href="#" id="nav-2">profile</a>');

$('#nav-3').html('<a class="nav-link active" aria-current="page" href="#" id="nav-3"></a>');
