// favorite1
$('.favorite1').children('p').text('ワードプレスのインストール');
$('.image').attr('src','../images/wp.png');
$('.read1').attr('href','../wordpress/index.html');
// favorite1
// favorite2
$('.favorite2').children('p').text('ドメイン設定');
$('.image2').attr('src','../images/domain.jpeg');
$('.read2').attr('href','../domain/index.html');
// favorite2
// favorite3
$('.favorite3').children('p').text('ブログって何？');
$('.image3').attr('src','../images/blog.jpeg');
$('.read3').attr('href','../blog/index.html');
// favorite3
